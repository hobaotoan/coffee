<template>
  <v-item-group mandatory class="mt-n1">
    <v-container>
        ...
        <v-col cols="12" md="2">
          <v-item v-slot="{ active, toggle }">
            ...
            >
              <v-row>
                <v-col cols="12" sm="12">
                  <v-list-item three-line class="text-center" href="/home">
                    <v-list-item-content>
                      <div align="center" justify="center">
                        <v-img
                          src="../DA-XAY-TOFFEE-1.png"
                          max-height="70"
                          max-width="110"
                          contain
                        ></v-img>
                  ...
                  <v-list-item three-line class="text-center" href="/home">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle
                        :class="active ? 'brown--text' : 'black--text'"
                        class="caption mt-2"
                        >Trà Nguyên Chất</v-list-item-subtitle
                      >
                    </v-list-item-content>
                  </v-list-item>
                </v-col>
                  ...
                  <v-list-item three-line class="text-center" href="/home">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle
                        :class="active ? 'brown--text' : 'black--text'"
                        class="caption mt-3"
                        >Latte Series</v-list-item-subtitle
                      >
                    </v-list-item-content>
                  </v-list-item>
                </v-col>
      ...
      <!-- <v-row no-gutters>
        <v-col sm="6" class="pa-3 mt-5" v-for="post in posts" :key="post._id">
          <v-card>
            <v-card
              flat
              class="rounded-lg"
            ...
            >
              <v-list-item three-line>
                ...
                <v-list-item-content>
                  ...
                  <v-row>
                    <v-col cols="">
                      <v-btn small outlined color="brown darken-4">{{
                        post.group
                      }}</v-btn>
                    </v-col>
                    <v-col cols="6">
                      <v-btn small outlined color="brown darken-4"
                        >Chỉ {{ post.category }} VND</v-btn
                      >
                    </v-col>
                  </v-row>
                </v-list-item-content>
...
<style>
.v-card.borderme {
  border: 2px solid #f6efef !important;
}
.v-card.borderout {
